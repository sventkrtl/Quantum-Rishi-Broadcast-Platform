...
Approved example responsibility area.

## Allowed Contents

- Stable examples that demonstrate documented architecture without defining it

## Forbidden Contents

- Architecture decisions
- experimental scratch work
- implementation that bypasses documentation
