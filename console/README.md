...
Operator control console responsibility area.

## Allowed Contents

- Dashboard, graphics, scheduler, assets, settings, monitoring, diagnostics, plugins, and logs boundaries

## Forbidden Contents

- Platform kernel ownership
- renderer internals
