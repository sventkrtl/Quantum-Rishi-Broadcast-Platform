...
Approved extension responsibility area.

## Allowed Contents

- Plugin manifests, plugin documentation, plugin contracts, and approved extension boundaries

## Forbidden Contents

- Core architecture changes
- hidden dependencies
- direct mutation of unrelated module internals
